...
export default function Sidebar({
  ...
  return (
    <>
      <div 
        className={`bg-white dark:bg-[#111827] flex flex-col h-screen fixed md:relative z-40 transition-all duration-300 ease-in-out shadow-lg shadow-slate-100 dark:shadow-none ${
          isSidebarOpen 
            ? "w-72 translate-x-0 border-r border-slate-200 dark:border-[#374151]" 
      ...
      >
        ...
        <div className="p-4 border-b border-slate-100 dark:border-[#374151] shrink-0 flex items-center justify-between bg-slate-50/50 dark:bg-[#111827]">
          ...
          <button 
            ...
            className="p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-[#1F2937] text-slate-400 hover:text-blue-600 dark:hover:text-[#3B82F6] transition shrink-0 cursor-pointer border-none bg-transparent" 
        ...
        <div className="p-4 border-b border-slate-100 dark:border-[#374151] shrink-0 flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2 pt-2 border-t border-slate-100 dark:border-slate-800/60 mt-1">
            {/* Language Dropdown */}
            <div className="relative flex-1 flex items-center">
              <Languages className="absolute left-2.5 h-3.5 w-3.5 text-slate-400 pointer-events-none" />
              <select
                value={currentLang}
                onChange={(e) => {
                  handleUpdateLanguage(e.target.value as "en" | "hi");
                }}
                className="w-full pl-8 pr-2 py-1.5 rounded-xl bg-slate-50 hover:bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-350 text-[10px] font-bold border border-slate-150 dark:border-slate-800/80 focus:outline-hidden cursor-pointer transition duration-150 appearance-none select-none"
            ...
            <button
              ...
              className="p-1.5 rounded-xl bg-slate-50 hover:bg-slate-100 dark:bg-slate-900 text-slate-500 dark:text-slate-450 hover:text-blue-600 dark:hover:text-[#3B82F6] transition cursor-pointer border border-slate-150 dark:border-slate-800/80 flex items-center justify-center shrink-0"
          ...
          <div className="space-y-1">
            <div className="text-[10px] uppercase tracking-widest font-extrabold text-slate-400 px-3 mb-2 flex items-center justify-between">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition p-1 rounded hover:bg-slate-100 dark:hover:bg-[#1F2937] cursor-pointer border-none bg-transparent"
            ...
            {isFeaturesMinimized ? (
              <div className="grid grid-cols-7 gap-1 bg-slate-50 dark:bg-slate-900/60 p-1.5 rounded-xl border border-slate-100 dark:border-slate-800/80">
                ...
                <button
                  ...
                  className={`p-2 rounded-lg flex items-center justify-center transition cursor-pointer border-none ${
                    activeTab === "chat" 
              ...
              <>
                ...
                <button
                  ...
                  className={`w-full rounded-xl flex items-center gap-3 transition font-semibold text-xs cursor-pointer text-left px-3.5 py-3 border-none ${
                    activeTab === "chat" 
                      ? "bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-[#3B82F6] border-l-4 border-blue-600 dark:border-[#3B82F6]" 
                      : "text-slate-600 dark:text-[#9CA3AF] hover:bg-slate-50 dark:hover:bg-[#1F2937] hover:text-slate-800 dark:hover:text-[#F9FAFB] bg-transparent"
                  }`}
                  title={t.aiAssistant}
                >
                ...
                >
                  ...
                  <span className="truncate">{t.nearbyResources}</span>
                </button>
                ...
                >
                  ...
                  <span className="truncate">{t.governmentSchemes}</span>
                </button>
                ...
                >
                  ...
                  <span className="truncate">{t.misinfoDetector}</span>
                </button>
                ...
                >
                  ...
                  <span className="truncate">{t.reportSaver}</span>
                </button>
          ...
          <div className="space-y-1">
            <div className="text-[10px] uppercase tracking-widest font-extrabold text-slate-400 px-3 mb-2 flex justify-between items-center">
              ...
              <button 
                ...
                className="text-[10px] text-blue-600 hover:underline flex items-center gap-0.5 cursor-pointer border-none bg-transparent"
              >
              ...
              {sessions.length === 0 ? (
                ...
                sessions.map((sess) => (
                  <div
                    ...
                    role="button"
                    tabIndex={0}
                    className={`w-full rounded-xl flex items-center transition text-xs font-medium cursor-pointer text-left justify-between px-3 py-2.5 ${
                      activeSessionId === sess.id && activeTab === "chat"
                        ...
                        : "text-slate-500 dark:text-[#9CA3AF] hover:bg-slate-50 dark:hover:bg-[#1F2937]/55 hover:text-slate-800 dark:hover:text-[#F9FAFB]"
                    }`}
                    title={sess.title}
                  >
                    ...
                    <button
                      ...
                      className="p-1 rounded-md text-slate-350 hover:text-red-500 hover:bg-slate-100 dark:hover:bg-[#1F2937] transition cursor-pointer border-none bg-transparent"
                      title="Delete Chat"
                    >
        ...
        <div className="p-3 border-t border-slate-100 dark:border-[#374151] bg-slate-50/50 dark:bg-[#111827] shrink-0">
          <div className="flex flex-col gap-3">
                    ...
                    <div className="space-y-2.5 bg-white dark:bg-slate-900/60 border border-slate-200/60 dark:border-slate-800 rounded-xl p-2.5 shadow-xs">
                        ...
                        <div className="flex items-center gap-0.5">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <button
                              ...
                              className="p-0.5 cursor-pointer transition-transform hover:scale-120 duration-150 border-none bg-transparent"
                            >
                              <Star 
                                className={`h-4 w-4 ${
                                  star <= feedbackRating 
                      ...
                      <div className="space-y-1.5">
                        ...
                        <button
                          ...
                          className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-bold py-1.5 rounded-lg text-[10px] cursor-pointer transition duration-150 flex items-center justify-center gap-1.5 shadow-xs border-none"
                        >
            ...
            <button 
              type="button"
              onClick={onLogout}
              className="w-full rounded-xl text-slate-500 dark:text-[#9CA3AF] hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition text-xs font-semibold flex items-center gap-2.5 cursor-pointer px-3 py-2.5 border-none bg-transparent"
              title={t.logout}
            >
